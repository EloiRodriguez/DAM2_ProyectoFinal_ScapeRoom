...
{
    private Dictionary<string, SimonButton> buttons;
    ...
    {   
        ...
        buttons = new Dictionary<string, SimonButton>();
        
        for (int i = 0; i < 4; i++) 
        {
            buttons.Add(colors[i], transform.GetChild(i).GetComponent<SimonButton>());
        }
